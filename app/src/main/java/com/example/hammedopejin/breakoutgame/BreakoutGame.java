...
public class BreakoutGame extends Activity {
    ...
    class BreakoutView extends SurfaceView implements Runnable {
        ...
        // Move the paddle if required
            ...
            // Bounce the ball of the paddle back when it hits the bottom of screen
            // And deduct a life
            if(ball.getRect().bottom > screenY){
                ball.reverseYVelocity();
                ball.clearObstacleX(paddle.getRect().left);
        ...
        // If Game Activity is started then
        // start our thread.
        public void resume() {
            playing = true;
    ...
    protected void onResume() {
        ...
        // Tell the breakoutView resume method to execute
        breakoutView.resume();
    }
    ...
    protected void onPause() {
        ...
        // Tell the breakoutView pause method to execute
        breakoutView.pause();
    }
